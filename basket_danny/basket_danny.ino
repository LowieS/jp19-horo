...
void loop() {
  ...
  */
  ...
  Braccio.ServoMovement(10,         90, 75, 60, 100, 90,  10); 
  Braccio.ServoMovement(20,         90, 65, 30, 5, 90,  5);
  delay(1500);
  Braccio.ServoMovement(20,         90, 65, 30, 5, 90,  50);
  delay(1500);
  Braccio.ServoMovement(20,         90, 125, 110, 100, 90,  50);  
  Braccio.ServoMovement(10,         90, 100, 100, 100, 90,  50);
